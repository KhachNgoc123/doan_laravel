       ...
       <h2 class="mb-4 text-primary"> Thêm sản phẩm mới</h2>
        ...
        <form action="{{ route('sanpham.store') }}" method="POST" enctype="multipart/form-data" class="card p-4 shadow-sm">
            ...
            <div class="row">
                ...
                <input type="number" class="form-control" id="soluong" name="soluong" value="{{ old('soluong') }}" required>
                </div>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="madm" class="form-label">Chọn danh mục</label>
            ...
            <div class="mb-3">
                <label for="tendm" class="form-label">Hoặc nhập tên danh mục mới</label>
                <input type="text" class="form-control" id="tendm" name="tendm" placeholder="Ví dụ: Điện thoại, Laptop...">
            </div>
            <div class="mb-3">
                <label for="trangthai" class="form-label">Trạng thái</label>
                <select class="form-select" id="trangthai" name="trangthai">
                    <option value="còn hàng">Hiển thị</option>
                    <option value="hết hàng">Ẩn</option>
                </select>
            </div>
